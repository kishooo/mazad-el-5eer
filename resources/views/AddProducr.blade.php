						...
						<div class="main-input padding60">
							...
							<div class="login-text">
								<div class="custom-input">
									<form id="my_form" action="Create" method="post" enctype="multipart/form-data">
                    @csrf
										<input type="text" name="Name" placeholder="Name" />
										<input type="text" name="description" placeholder="Description" />
                    <input type="text" name="startPrice" placeholder="Starting Price" />
                    <input type="text" name="buyNow" placeholder="your final Price (Buy Name)" />
                    <input type="file" name="Image" placeholder="Image" />
										<div class="submit-text">
											<a href="javascript:{}" onclick="document.getElementById('my_form').submit();">ADD</a>
										</div>
                    @if($errors->any())
